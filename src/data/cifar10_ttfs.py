...
def build_cifar10_ttfs_loaders(
    data_root: Path,
    split_path: Path,
    batch_size: int,
    num_workers: int,
    ...
    train_base = datasets.CIFAR10(root=str(data_root / "raw"), train=True, download=True, transform=transform)
    test_base = datasets.CIFAR10(root=str(data_root / "raw"), train=False, download=True, transform=transform)
